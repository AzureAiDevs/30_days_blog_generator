...
class BANNER_1080p:
    ...
    def __add_banner_text(self, draw, audience, title, day):
        ...
        self.__add_text(draw, "{:2d}".format(day), day_loc, day_font_size, self.font_bold_name, (127, 127, 127))
    ...
    def __add_profile_image(self, img, draw, item, name, tag, image_url):
        ...
        name_loc = [(470, 484), (470, 694)]
        tag_loc = [(470, 554), (470, 764)]
        image_loc = [(320, 485), (320, 695)]
        font_size = 46
    ...
    def __add_keyword_image(self, img, draw, keywords):
        ...
        keyword_loc = [(1030, 490), (1230, 490), (1430, 490), (1630, 490),
                       (1030, 700), (1230, 700), (1430, 700), (1630, 700)]
        keyword_count = 0
